...
class SimpleDataBMTCases(FixtureParameterFactory):
    ...
    def data_full(self):
        ...
        true_ci = np.array([0.00209089835686539,0.00993325494186119,0.00993325494186119,0.0522076951264071,0.0888838138636172,0.0888838138636172,0.0888838138636172,0.110011886671636,0.110011886671636,0.110011886671636,0.133005023809541,0.133005023809541,0.133005023809541,0.133005023809541,0.133005023809541,0.133005023809541,0.133005023809541,0.133005023809541,0.133005023809541,0.133005023809541,0.133005023809541,0.00209089835686539,0.00993325494186119,0.0214748329939906,0.0357187819044409,0.0518877502816666,0.0700266731183927,0.110158398371068,0.132478732395921,0.156742376729941,0.182165162211577,0.182165162211577,0.208554478735087,0.235937626428187,0.264264187678628,0.293498034302868,0.293498034302868,0.293498034302868,0.293498034302868,0.293498034302868,0.293498034302868,0.293498034302868
        ,0.128908843494157,0.169258331034294,0.169258331034294,0.284895585897948,0.354139026652729,0.354139026652729,0.354139026652729,0.392515236920039,0.392515236920039,0.392515236920039,0.433322183526174,0.433322183526174,0.433322183526174,0.433322183526174,0.433322183526174,0.433322183526174,0.433322183526174,0.433322183526174,0.433322183526174,0.433322183526174,0.433322183526174,0.128908843494157,0.169258331034294,0.207754020042252,0.246395720637522,0.283125964193271,0.320890674338199,0.392311623528331,0.429252909468147,0.468497719480401,0.506294418343986,0.506294418343986,0.542939937694652,0.578453223376495,0.612928543627949,0.646430642986594,0.646430642986594,0.646430642986594,0.646430642986594,0.646430642986594,0.646430642986594,0.646430642986594]).reshape(2,2,21)

        return event, time, true_x, true_y, true_ci
    ...
    def data_ALL(self):
        ...
        true_ci = np.array([0.00348707411146034,0.0181936033206225,0.0181936033206225,0.0181936033206225,0.0181936033206225,0.0181936033206225,0.0181936033206225,0.0181936033206225,0.0399122122820207,0.0399122122820207,0.0399122122820207,0.0399122122820207,0.0399122122820207,0.0399122122820207,0.0399122122820207,0.00348707411146034,0.0181936033206225,0.0410141679189917,0.0694763504624898,0.102262088424987,0.138578196529938,0.177902071439043,0.219856883518548,0.219856883518548,0.263360368677176,0.30865270447556,0.35515164752905,0.401655423612536,0.401655423612536,0.401655423612536,0.242066469668543,0.318841745277701,0.318841745277701,0.318841745277701,0.318841745277701,0.318841745277701,0.318841745277701,0.318841745277701,0.392934887315711,0.392934887315711,0.392934887315711,0.392934887315711,0.392934887315711,0.392934887315711,0.392934887315711,0.242066469668543,0.318841745277701,0.389817371375673,0.456092168213363,0.518512395968731,0.57763628936226,0.633809098028575,0.687230296294618,0.687230296294618,0.738483171643281,0.787004633929124,0.832721242624499,0.875464920860131,0.875464920860131,0.875464920860131]).reshape(2,2,15) #LU, n_risks, n_t
    ...
    def data_AML(self):
        ...
        # TODO: Check which are better 0s or NaNs.
        true_ci = np.array([0.,0.0410510751355923,0.102383645574697,0.102383645574697,0.140757198197709,0.140757198197709,0.140757198197709,0.140757198197709,0.140757198197709,0.140757198197709,0.140757198197709,0.00336469994281798,0.00336469994281798,0.00336469994281798,0.0177760712559133,0.0177760712559133,0.0418813836906459,0.0418813836906459,0.0418813836906459,0.0418813836906459,0.0418813836906459,0.0418813836906459,
                            0.,0.391182936235333,0.520265270665424,0.520265270665424,0.600995173316025,0.600995173316025,0.600995173316025,0.600995173316025,0.600995173316025,0.600995173316025,0.600995173316025,0.230594432816273,0.230594432816273,0.230594432816273,0.329134054270613,0.329134054270613,0.454716965103197,0.454716965103197,0.454716965103197,0.454716965103197,0.454716965103197,0.454716965103197]).reshape(2,2,11)
...
class TestKaplanMeierCompetingRisks:
    @staticmethod
    @pytest.mark.parametrize("event, time, true_x, true_y, true_ci", SimpleDataBMTCases().get_cases())
    def test_full(event, time, true_x, true_y, true_ci):
        x, y, ci_cr, _ = km_cumulative_incidence_competing_risks(event, time, conf_level=0.95, conf_type='log-log')

        assert_array_equal(x, true_x)
        _x_km, true_km, ci_no_cr = kaplan_meier_estimator(event > 0, time, conf_level=0.95, conf_type='log-log')
        assert_array_almost_equal(y[0], 1. - true_km)
        assert_array_almost_equal(y[1:], true_y)
        assert_array_almost_equal(ci_cr, true_ci)
